...
ball.penup()
ball.goto(0, 0)
ball_dx = 5.0 # Setting up the pixels for the ball movement.
ball_dy = 5.0
...
pen.hideturtle()
pen.goto(0, 260)
pen.write("Player A: 0    time count:0                Player B: 0 ", align="center", font=('Monaco', 24, "normal"))
...
while True:
    ...
    if ball.xcor() > 390:  # right width paddle Border
        ...
        pen.clear()
        pen.write("Player A: {}      timecount: {}              Player B: {} ".format(player_a_score,timecount/79, player_b_score),
